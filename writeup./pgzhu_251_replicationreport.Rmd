...
library(tidyverse) #and others if necessary
library(qualtRics)
...
#filter out participants that did not pass comprehension check
#filter out irrelevant columns

#### Prepare data for analysis - create columns etc.

#prepare data so it's in the right form for data analysis
```
...
#will fill in code once I have data, but use anova function to perform the mixed anova
